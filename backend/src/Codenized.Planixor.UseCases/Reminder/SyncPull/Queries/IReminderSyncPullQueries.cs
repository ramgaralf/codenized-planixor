...
/// <summary>
/// Defines read operations for reminder synchronization pull.
/// </summary>
public interface IReminderSyncPullQueries
{
    ...
    Task<ReminderSyncPullResult> GetModifiedAfterAsync(Guid userId, DateTime lastSyncedAt, string? cursor);
}
