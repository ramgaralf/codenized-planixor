...
public sealed class ShiftSyncPullService : IInteractorService<ShiftSyncPullRequest, ShiftSyncPullResponse>
{
    ...
    public async Task<ShiftSyncPullResponse> Run(ShiftSyncPullRequest request, CancellationToken cancellationToken)
    {
        ...
        return new ShiftSyncPullResponse(shifts, result.Cursor, result.HasMore, serverSyncedAt);
    }
}
