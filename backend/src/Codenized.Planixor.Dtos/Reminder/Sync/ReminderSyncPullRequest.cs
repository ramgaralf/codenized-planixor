// <copyright file="ReminderSyncPullRequest.cs" company="Codenized">
...
/// <summary>
/// Request parameters for pulling reminder records from API to client.
/// </summary>
...
public record ReminderSyncPullRequest(string UserId, DateTime? LastSyncedAt, string? Cursor);
