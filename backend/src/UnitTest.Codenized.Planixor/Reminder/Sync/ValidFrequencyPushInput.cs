// <copyright file="ValidFrequencyPushInput.cs" company="Codenized">
...
/// <summary>Valid frequency push input, used by <see cref="ReminderSeriesSyncPropertyTests"/>.</summary>
