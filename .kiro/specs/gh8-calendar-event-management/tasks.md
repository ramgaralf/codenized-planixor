...
- [ ] 1. Migrate data model and validation (React Web)
  - [ ] 1.1 Update models.ts with new multi-day fields
  ...
  - [ ] 1.2 Update constants.ts with new limits and i18n keys
  ...
  - [ ] 1.3 Rewrite validation.ts with new validation functions
  ...
  - [ ] 1.4 Update Dexie schema to v5 for multi-day model
  ...
  - [ ] 1.5 Update calendarEventService.ts for new model
  ...
  - [ ] 1.6 Write property tests for new validation functions
...
- [ ] 2. Migrate form and UI (React Web)
  - [ ] 2.1 Update useEventForm.ts for multi-day and conditional times
  ...
  - [ ] 2.2 Update EventForm.tsx for new fields and conditional editability
  ...
  - [ ] 2.4 Update view components for range intersection filtering
  ...
  - [ ] 2.6 Update i18n files with new keys
  ...
  - [ ] 2.7 Fix all existing tests for new model
...
- [ ] 3. Migrate sync (React Web)
  - [ ] 3.1 Update calendarEventSync.ts for new DTO fields
...
- [ ] 4. Migrate backend
  - [ ] 4.1 Update CalendarEvent.cs entity for new model
  ...
  - [ ] 4.2 Update EF Core configuration and add migration
  ...
  - [ ] 4.4 Update CalendarEventSyncPushService validation
  ...
  - [ ] 4.5 Update CalendarEventSyncPullService for new fields
...
- [ ] 5. Migrate Android
  - [ ] 5.1 Update Android entities and models for new fields
  ...
  - [ ] 5.3 Update CalendarEventRepository.kt for new validation
  ...
  - [ ] 5.5 Update Room migration for new schema
  ...
  - [ ] 5.7 Update EventFormScreen.kt UI for new fields
