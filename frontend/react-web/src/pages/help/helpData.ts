...
const en: HelpData = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: '4. Reminders',
      intro:
        'Reminders are reusable templates similar to shifts but without fixed time constraints. They represent recurring events or tasks you want to track on your calendar (e.g., "Take Medicine", "Team Meeting"). Reminders support optional repetition series that automatically generate calendar events at regular intervals.',
      steps: [
        'Create a reminder: Go to Reminders, press "+". Enter a name, pick an emoji icon, and choose a color.',
        'Set the repetition frequency: Never (default), Every week, Every month, or Every year.',
        'If you choose a frequency other than Never, a "Repeat until" date picker appears with a suggested end date (weekly: +1 year, monthly: +5 years, yearly: +50 years).',
        'When you create a calendar event from a reminder with repetition, the system automatically generates recurring events through the end date.',
        'Edit a reminder by tapping the edit icon on the reminder card.',
        'If you change the frequency on a reminder that already has events, a dialog asks if you want to update existing events or keep them.',
    ...
    },
    {
      ...
      steps: [
        ...
        'Series events: When you create an event from a reminder with repetition, all generated events are linked as a series.',
        'Editing a series event: A dialog asks "Only this event?" or "All future events in series?" — past events are never modified.',
...
const es: HelpData = {
  ...
  sections: [
    ...
    },
    {
      ...
      intro:
        'Los recordatorios son plantillas reutilizables similares a los turnos pero sin restricciones de tiempo fijas. Representan eventos o tareas recurrentes que quieres seguir en tu calendario (ej: "Tomar Medicación", "Reunión de Equipo"). Los recordatorios admiten series de repetición opcionales que generan automáticamente eventos de calendario a intervalos regulares.',
      steps: [
        'Crear un recordatorio: Ve a Recordatorios, presiona "+". Introduce un nombre, elige un emoji y selecciona un color.',
        'Establece la frecuencia de repetición: Nunca (por defecto), Cada semana, Cada mes o Cada año.',
        'Si eliges una frecuencia distinta a Nunca, aparece un selector de fecha "Repetir hasta" con una fecha sugerida (semanal: +1 año, mensual: +5 años, anual: +50 años).',
        'Al crear un evento de calendario a partir de un recordatorio con repetición, el sistema genera automáticamente eventos recurrentes hasta la fecha de fin.',
        'Edita un recordatorio tocando el icono de editar en la tarjeta del recordatorio.',
        'Si cambias la frecuencia de un recordatorio que ya tiene eventos, un diálogo pregunta si deseas actualizar los eventos existentes o mantenerlos.',
    ...
    },
    {
      ...
      steps: [
        ...
        'Eventos de serie: Al crear un evento a partir de un recordatorio con repetición, todos los eventos generados se vinculan como una serie.',
        'Editar un evento de serie: Un diálogo pregunta "¿Solo este evento?" o "¿Todos los eventos futuros de la serie?" — los eventos pasados nunca se modifican.',
